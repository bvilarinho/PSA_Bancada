                            ...
                            <div class="row align-items-center gx-0">
                                <div class="col">
                                    ...
                                    <?php 
                                        ...
                                        $veri = "SELECT * FROM `avarias` WHERE id_comp = $id_comp AND id_avarias = 1" ;                                    
                                        $ql = mysqli_query($conn, $veri); 
                                        if ($ql->num_rows > 0) {                                
                                            $av_hum = "Anomalia Detetada ";
                                            // selecionar a data da ultima avaria e colocar no php;
                                        } else {
                                            $av_hum = "0 results";
                                        }
                                        $veri = "SELECT * FROM `avarias` WHERE id_comp = $id_comp AND id_avarias = 2" ;                                    
                                        $ql = mysqli_query($conn, $veri); 
                                        if ($ql->num_rows > 0) {                                
                                        ...
                                        $veri = "SELECT * FROM `avarias` WHERE id_comp = $id_comp AND id_avarias = 3" ;                                    
                                        $ql = mysqli_query($conn, $veri); 
                                        if ($ql->num_rows > 0) {                                
                                    ...
                                    <p><span class="h6"> Humidade: <?php echo $av_hum; //echo $data da ultima avaria;?></span>
                                    <p><span class="h6"> Vibração: <?php echo $av_vib; //echo $data da ultima avaria;?></span>
                                    <p><span class="h6"> Ruido: <?php echo $av_ru; //echo $data da ultima avaria;?></span>
                                </div>
                            </div>
                        </div>
                    </div>
